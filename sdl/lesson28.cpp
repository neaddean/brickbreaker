...
bool load_files()
{
    ...
    //Set alpha
	const int bl = 50;
    SDL_SetAlpha( red, SDL_SRCALPHA | SDL_RLEACCEL, bl );
    SDL_SetAlpha( blue, SDL_SRCALPHA | SDL_RLEACCEL, bl );
    SDL_SetAlpha( green, SDL_SRCALPHA | SDL_RLEACCEL, bl );
    SDL_SetAlpha( shimmer, SDL_SRCALPHA | SDL_RLEACCEL, bl );
